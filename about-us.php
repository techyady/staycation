        ...
        <div class="container">
            <div class="about-page-text">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ap-title">
                            <h2><?php echo $row['detail_liner'];?></h2>
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <ul class="ap-services">
                            ...
                            <li><i class="icon_check"></i> Budget-freindly.</li>
                            <li><i class="icon_check"></i> for 1 day picnic lover</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        <h2><?php echo $row['detail_video_head'];?></h2>
                        <p><?php echo $row['detail_video_liner'];?></p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <span><?php echo $row['detail_gallery_head'];?></span>
                        <h2><?php echo $row['detail_gallery'];?></h2>
                    </div>
                </div>
            </div>
            <div class="row">
