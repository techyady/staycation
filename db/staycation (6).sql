...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2024 at 03:55 PM
...
INSERT INTO `contact_form` (`id`, `cname`, `cemail`, `cmessage`, `InsertedOn`) VALUES
(4, 'ADITYA GURAV', 'guravadi@gmail.com', 'testing', '2024-11-23 14:34:32');
...
INSERT INTO `login` (`id`, `username`, `password`, `admin_status`, `status`, `InsertedOn`) VALUES
(1, 'admin', '1234567', 'Y', 'Y', '2024-11-23 14:35:41'),
(2, 'User', '1234567', 'N', 'N', '2024-11-23 14:35:41');
...
INSERT INTO `rooms` (`id`, `head`, `fee`, `size`, `capacity`, `bed`, `services`, `img`, `room_detail_img`, `details`) VALUES
(1, 'Couples Retreat', '1000', '20ft', '2 person', '1 normal bed', 'Bathroom,TV,AC,Non-AC', 'img\\room\\sk_4.jpeg', 'img\\room\\room_deatil_2.jpeg', 'Motorhome or Trailer that is the question for you. Here are some of the advantages and disadvantages of both, so you will be confident when purchasing an RV. When comparing Rvs, a motorhome or a travel trailer, should you buy a motorhome or fifth wheeler? The advantages and disadvantages of both are studied so that you can make your choice wisely when purchasing an RV. Possessing a motorhome or fifth wheel is an achievement of a lifetime. It can be similar to sojourning with your residence as you search the various sites of our great land, America.'),
...
(4, 'Spacious Family Oasis\r\n', '10000', '20ft', '10 person', '3 normal bed', 'Bathroom,TV,AC,Non-AC', 'img\\room\\hh_4.jpeg', 'img\\room\\hh_detail_4.jpeg', 'The two commonly known recreational vehicle classes are the motorized and towable. Towable rvs are the travel trailers and the fifth wheel. The rv travel trailer or fifth wheel has the attraction of getting towed by a pickup or a car, thus giving the adaptability of possessing transportation for you when you are parked at your campsite.');
...
INSERT INTO `room_availability` (`id`, `room_id`, `hotel_name`, `hotel_room_name`, `Status`, `dtfrom`, `dtto`) VALUES
(1, '1', 'Happiness Inn', 'Couples Retreat', 'No', '2023-07-01', '2023-07-02'),
...
CREATE TABLE `room_inquiry` (
  ...
  `guest` varchar(51) NOT NULL,
  `room` varchar(51) NOT NULL,
...
INSERT INTO `room_inquiry` (`id`, `checkIn`, `checkOut`, `guest`, `room`, `room_id`, `InsertedOn`) VALUES
(18, '2024-11-24', '2024-11-25', '1 Adult', '1 Room', 1, '2024-11-23 14:31:53');
