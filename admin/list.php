...
$file = fopen($filexlsPath, "w") or die("Unable to open file!");
fwrite($file, "-----End of line-----");
fclose($file);
...
header('Content-Length: ReadMe.txt');
ob_clean();
flush();
readfile('ReadMe.txt');
exit();
?>
<!-- <a href="list.php" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span class="txt">List</span></a> -->
