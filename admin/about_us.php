...
<li class="nav-item">
<div class="nav-link">Welcome <?php echo $_SESSION['valid']; ?><a href="logout.php" tite="Logout">Logout.</a></div>
</li>
...
<td>Detail Liner</td>
<td>Detail Desc</td>
<td>Detail Video Head</td>
<td>Detail Video Liner</td>
<td>Detail Gallery</td>
<td>Detail Gallery Head</td>
<td>Action</td>
</tr>
</thead>
<tbody>
<?php
$ret=mysqli_query($con,"SELECT * FROM about_us");
$cnt=1;
...
<td> <?php  echo $row['detail_liner'];?></td>
<td> <?php  echo $row['detail_desc'];?></td>
<td> <?php  echo $row['detail_video_head'];?></td>
<td> <?php  echo $row['detail_video_liner'];?></td>
<td> <?php  echo $row['detail_gallery'];?></td>
<td> <?php  echo $row['detail_gallery_head'];?></td>
<td>
<?php
...
<a href="read.php?viewid=<?php echo htmlentities ($row['id']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
    <a href="edit_about.php?editid=<?php echo htmlentities ($row['id']);?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
