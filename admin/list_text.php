...
<a href="upload.php" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Add Detail</span></a>
...
// render headers
echo '<tr bgcolor="#CCCCCC"><th>Name</th><th>Position</th><th>Department</th>
        <th>Date of Birth</th><th>Date & Time</th><th>Action</th></tr>';
        ...
        //$final = explode("\n",$info);
        echo "<td>$info</td>";
        // echo "<td>Edit</td>"; // render data item
        $count++;
    	} else {
