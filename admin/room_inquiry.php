...
<tbody>
<?php
$ret=mysqli_query($con,"SELECT  *,room_availability.hotel_name,room_availability.Status FROM room_inquiry left join room_availability on room_inquiry.room_id = room_availability.room_id");
$cnt=1;
...
<a href="read.php?viewid=<?php echo htmlentities ($row['id']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
    <a href="room_avl_edit.php?editid=<?php echo htmlentities ($row['id']);?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
